			...
			<div class="container">
		        ...
		        <div id="navbar" class="navbar-collapse collapse">
		          <ul class="nav navbar-nav navbar-right">
		            ...
		            <li><a href="#" data-nav-section="testimonials"><span>Teams</span></a></li>
		            <li><a href="#" data-nav-section="services"><span>Players</span></a></li>
		            <li><a href="#" data-nav-section="about"><span>Your Account</span></a></li>
		          </ul>
		        </div>
			    </nav>
			  <!-- </div> -->
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<h1 class="to-animate">Create your team to win the All-Ireland! </h1>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row-bottom-padded-lg">
				<div class="fh5co-block to-animate" style="background-image: url(images/img_7.jpg);">
					...
					<div class="fh5co-text">
						<i class="fh5co-intro-icon icon-soccer-ball-o"></i>
				...
				<div class="fh5co-block to-animate" style="background-image: url(images/img_8.jpg);">
					...
					<div class="overlay"></div>
					<div class="fh5co-text">
						<i class="fh5co-intro-icon icon-trophy"></i>
						<h2>Scoreboard</h2>
						<p>
						View the top teams this season, have a look at your competition!</p>
