        ...
        <div class="row row-bottom-padded-lg">
            <div class="fh5co-block to-animate" style="background-image: url(images/img_7.jpg);">
                ...
                <div class="fh5co-text"> <i class="fh5co-intro-icon icon-soccer-ball-o"></i>
                    ...
                    <p><a href="?page=member" class="btn btn-primary">Get Started</a></p>
                </div>
            </div>
            <div class="fh5co-block to-animate" style="background-image: url(images/img_8.jpg);">
                ...
                <div class="fh5co-text"> <i class="fh5co-intro-icon icon-trophy"></i>
                    ...
                    <p><a href="?page=scoreboard" class="btn btn-primary">View</a></p>
                </div>
            </div>
            <div class="fh5co-block to-animate" style="background-image: url(images/img_10.jpg);">
                ...
                <div class="fh5co-text"> <i class="fh5co-intro-icon icon-cogs"></i>
                    ...
                    <p><a href="?page=teamManager" class="btn btn-primary">Manage</a></p>
                </div>
            </div>
        </div>
    </div>
